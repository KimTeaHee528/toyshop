...
public class codeVo {
	...
	public String getSh_div() {
		return sh_div;
	}
	public void setSh_div(String sh_div) {
		this.sh_div = sh_div;
	}
	...
	public String getSh_use_ny() {
		return sh_use_ny;
	}
	public void setSh_use_ny(String sh_use_ny) {
	...
	public String getSh_date_rm() {
		return sh_date_rm;
	}
	public void setSh_date_rm(String sh_date_rm) {
