			...
			<div class="shopping-cart">
				...
				<div class="cart-ship-info register">
					<div class="row">
						...
						<div class="col-sm-12">
							<h6>코드그룹 등록</h6> 
							<form id="ins" method="post" action="/codeGroup/codeGroupInst">
								<ul class="row">

									<li class="col-md-6">
										<label>
											코드그룹 코드 
											<input type="text" name="first-name" value="" placeholder="영문(대소문자), 숫자">
										</label>
									</li>
									<li class="col-md-6">
										<label>
									...
									<li class="col-md-6" style="margin-top: 0px;">
										<label>순서
											<input type="password" name="" value="" placeholder="숫자">
										</label>
									</li>
